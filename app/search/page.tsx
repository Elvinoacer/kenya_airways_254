          ...
          <div className="lg:col-span-4 xl:col-span-3">
            <div className="bg-white p-5 md:p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#e5e2e1]">
              <h2 className="text-xl font-bold text-[#1A1A1A] mb-6 flex items-center gap-2">
                <span
                  className="material-symbols-outlined text-[#e71520]"
                  aria-hidden="true"
                >
                  travel_explore
                </span>
              ...
              <form
                onSubmit={(e) => {
                  ...
                  const next: SearchParams = {
                    ...
                    currency: String(form.get("currency") || "USD") as
                      | "USD"
                      | "KES",
                  };
              ...
              >
                ...
                <div className="bg-[#fcf9f8] p-1.5 rounded-xl flex items-center border border-[#e5e2e1]">
                  <button
                    type="button"
                    onClick={() =>
                      setParams((prev) => ({ ...prev, tripType: "return" }))
                    }
                ...
                <div className="space-y-4 relative">
                  <div>
                    <label
                      htmlFor="origin"
                      className="block text-sm font-medium text-[#5e3f3c] mb-1.5"
                    >
                      From
                    </label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div
                    className={`${params.tripType === "oneway" ? "opacity-50 pointer-events-none" : ""}`}
                  >
                    <label
                      htmlFor="returnDate"
                      className="block text-sm font-medium text-[#5e3f3c] mb-1.5"
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setParams((c) => ({
                          ...c,
                          currency: (e.target as HTMLSelectElement).value as
                            | "USD"
                            | "KES",
                        }))
                      }
                    ...
                    {[
                      ...
                      >
                        <input
                          ...
                          type="checkbox"
                          defaultChecked={
                            params[checkbox.id as keyof SearchParams] === "true"
                          }
                          className="w-4 h-4 text-[#e71520] bg-white border-[#e5e2e1] rounded focus:ring-[#e71520]"
                        />
                        <span className="text-sm font-medium text-[#5e3f3c] group-hover:text-[#1A1A1A]">
                          {checkbox.label}
                        </span>
                      </label>
                    ))}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      placeholder="Min $"
                      type="number"
                      className="w-full px-3 py-2 text-sm rounded-lg border border-[#e5e2e1]"
                    />
                    <input
                      name="priceMax"
          ...
          <div className="lg:col-span-8 xl:col-span-9 min-w-0">
            ...
            <div className="mb-6 bg-white p-4 rounded-2xl shadow-sm border border-[#e5e2e1] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <span
                  className="material-symbols-outlined text-[#5e3f3c] text-sm"
                  aria-hidden="true"
                >
                  sort
                </span>
            ...
            {!loading && error && (
              <div className="mb-4 rounded-2xl border-l-4 border-[#e71520] bg-[#fff5f5] p-6 flex items-start gap-4">
                <span
                  className="material-symbols-outlined text-[#e71520] text-2xl"
                  aria-hidden="true"
                >
                  error
                </span>
                <div>
                  <h3 className="font-bold text-[#e71520] mb-1">
                    We hit a snag
                  </h3>
            ...
            {!loading && !error && results.length === 0 && initialized && (
              <div className="flex flex-col items-center justify-center py-28 bg-white rounded-3xl border border-[#e5e2e1] text-center px-6">
                ...
                <p className="text-[#5e3f3c] max-w-md mx-auto">
                  Try adjusting your filters or route.
                </p>
                <button
                  onClick={() =>
                    setParams({
                  ...
                  className="mt-6 px-6 py-2.5 rounded-lg border-2 border-[#e5e2e1] font-semibold"
                >
                  Clear filters
                </button>
              </div>
