...
export default function KenyaAirwaysPage() {
  return (
    <>
      ...
      <div
        id="top"
        className="bg-[#fcf9f8] text-[#1c1b1b] antialiased pt-[80px]"
      ...
      >
          ...
          <div className="relative z-10 w-full max-w-5xl px-5 md:px-20 mt-12">
            ...
            >
              ...
              <p className="text-lg text-[#5e3f3c] mb-8">
                Exclusive Flight Savings with Mastercard. Discover the world
                with us.
              </p>
              <BookingWidget />
            </div>
        ...
        <section
          id="offers"
          className="scroll-mt-24 py-24 px-5 md:px-20 max-w-7xl mx-auto"
        >
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold text-[#1A1A1A] mb-2">
                Exclusive Offers from New York
              </h2>
              <p className="text-base text-[#5e3f3c]">
                Discover premium destinations at unbeatable prices.
              </p>
            </div>
            <Link
              ...
              >
                ...
                <div className="relative z-10 w-full md:w-2/3">
                  ...
                  <p className="text-base text-white/80 mb-6">
                    Stay updated with the latest guidelines to ensure a smooth
                    journey.
                  </p>
        ...
        <section
          id="experience"
          className="scroll-mt-24 py-24 max-w-7xl mx-auto px-5 md:px-20"
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-5 flex flex-col gap-8">
              <div>
                ...
                <p className="text-lg text-[#5e3f3c] mb-8">
                  From exclusive student offers to in-flight luxury shopping, we
                  curate every moment of your travel to be exceptional.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl border border-[#f0edec] shadow-[0_12px_32px_rgba(13,13,13,0.08)] group">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#a33c33]/10 flex items-center justify-center flex-shrink-0">
                    <span className="material-symbols-outlined text-[#a33c33]">
                      school
                    </span>
                  </div>
                  <div>
                    <h4 className="text-2xl font-semibold text-[#1A1A1A] mb-2">
                      Kool Flyer&apos;s Club
                    </h4>
                    <p className="text-base text-[#5e3f3c] mb-4">
                      Discover a world of great Student Offers with exclusive
                      unlimited access when you sign up.
                    </p>
                    <Link
                      href="/register"
              ...
              <div className="rounded-2xl overflow-hidden shadow-[0_12px_32px_rgba(13,13,13,0.08)] relative z-10 w-4/5 ml-auto">
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black/80 to-transparent">
                  ...
                  <p className="text-base text-white/90 mb-4">
                    Pre-order 48 hours before you fly.
                  </p>
                  <Link
                    href="/search"
        ...
        <section
          id="rewards"
          className="scroll-mt-24 w-full bg-[#410001] py-16 mt-8 relative overflow-hidden"
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, #410001 0%, rgba(65,0,1,0.9) 60%, transparent 100%)",
            }}
          />
          <div className="max-w-7xl mx-auto px-5 md:px-20 relative z-20 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-1/2 text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full border border-white/20 mb-6">
                <span className="material-symbols-outlined text-[#ffb4aa] text-[16px]">
                  stars
                </span>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-lg">
                Join Asante Rewards and unlock exclusive benefits. Use promo
                code ASANTE10 on your next booking.
              </p>
